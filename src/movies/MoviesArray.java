...
public class MoviesArray {
    public static Movie[] findAll() {
        return new Movie[]{
                ...
                new Movie("High Anxiety", "comedy"),
                new Movie("Young Frankenstein", "comedy"),
                new Movie("Monty Python and the Holy Grail", "comedy"),
                new Movie("The Blues Brothers", "comedy"),
                new Movie("The Naked Gun", "comedy"),
                new Movie("Airplane", "comedy"),
                new Movie("The Producers", "comedy"),
                new Movie("The Jerk", "comedy"),
                new Movie("The Pink Panther", "comedy"),
                new Movie("Couregeous", "drama"),
                new Movie("The Patriot", "drama")
        };
    }
}
